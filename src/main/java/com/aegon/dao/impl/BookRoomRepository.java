...
public interface BookRoomRepository extends Repository<Customers, Long> {
	...
	public final static String FIND_BY_COST_BY_CUSTOMER_ID_QUERY = "select SUM(r.roomPrice + r.breakFastPrice) from OccupiedRooms b, Room r where ((b.roomId=r.roomId) AND (b.customerId = :customerId))";
